...
from streaming_sep.data import STEM_TO_ID
...
def main() -> None:
    ...
    parser.add_argument("--stem", choices=sorted(STEM_TO_ID), default="vocal")
    ...
    generated = []
    stem_id = torch.tensor([STEM_TO_ID[args.stem]], dtype=torch.long, device=device)
